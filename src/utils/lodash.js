...
(function () {
  ...
  var mn = function (n, t) {
    ...
    n: {
      for (t = g(t), e = n.length, r += -1; ++r < e;) if (t(n[r], r, n)) {
        n = r;
        break n;
      }
    ...
    for (r && (u = 1); ++e < u;) for (o = t[e], r = In(o), i = -1, c = r.length; ++i < c;) {
      var f = r[i],
          a = n[f];
  ...
  o.assignIn = Bn, o.before = G, o.bind = En, o.chain = function (n) {
    ...
    chain: false
  }), o.VERSION = "4.17.5", mn("pop join replace reverse split push shift sort splice unshift".split(" "), function (n) {
