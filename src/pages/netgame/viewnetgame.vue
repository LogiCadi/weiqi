...
export default {
  ...
  onShareAppMessage: function () {
    let thepath = "/pages/netgame/netmain?type=3&roomid=" + this.option.roomid + "&gamedeskid=" + this.option.gamedeskid + "&blackuserid=" + this.option.blackuserid + "&whiteuserid=" + this.option.whiteuserid + "&fromuserid=" + app.globalData.userid;
    return {
      title: '忘忧围棋网络对弈欢迎观战',
      path: thepath,
      imageUrl: '/',
  ...
  methods: {
    ...
    initPage() {
      ...
      this.startviewgame(parseInt(this.option.roomid), parseInt(this.option.gamedeskid), parseInt(this.option.blackuserid), parseInt(this.option.whiteuserid));
    },
    ...
    touchLineChartBegin: function (event) {
      console.log(event);
      wygogame.touchLineChartBegin(event);
    },
    touchLineChartEnd: function (event) {
      console.log(event);
      wygogame.touchLineChartEnd(event);
    },
    ...
    startviewgame: function (roomid, gamedeskid, blackuserid, whiteuserid) {
      if (app.globalData.userid > 0) {
        wygogame = new WYNetGame(this, 1, 0);
        wygogame.startviewgame(roomid, gamedeskid, blackuserid, whiteuserid);
      }
    },
    onSendMsg: function () {
